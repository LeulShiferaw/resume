...
class Matrix22Multiplication : public Monoid<Matrix22>
{
	public:
		Matrix22 e()const;
		Matrix22 op(const Matrix22&,const Matrix22&)const;
};

Matrix22 Matrix22Multiplication::e() const
{
...
Matrix22 Matrix22Multiplication::op(const Matrix22 &m1, const Matrix22 &m2) const
{
